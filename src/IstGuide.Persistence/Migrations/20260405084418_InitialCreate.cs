        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsAppUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagIconUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactRequests_Guides_GuideId",
                        column: x => x.GuideId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuideCertificates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuideCertificates_Guides_GuideId",
                        column: x => x.GuideId,
                        principalTable: "Guides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuideDistricts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuideDistricts_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GuideDistricts_Guides_GuideId",
                        column: x => x.GuideId,
                        principalTable: "Guides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuidePhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuidePhotos_Guides_GuideId",
                        column: x => x.GuideId,
                        principalTable: "Guides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    ReviewerCountry = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ReviewerLanguage = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuideSpecialties_Guides_GuideId",
                        column: x => x.GuideId,
                        principalTable: "Guides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuideSpecialties_Specialties_SpecialtyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_GuideId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuideCertificates_GuideId",
                table: "GuideCertificates",
                column: "GuideId");

            migrationBuilder.CreateIndex(
                name: "IX_GuideDistricts_DistrictId",
                table: "GuideDistricts",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_GuideDistricts_GuideId_DistrictId",
                table: "GuideDistricts",
                columns: new[] { "GuideId", "DistrictId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GuideLanguages_GuideId_LanguageId",
                table: "GuideLanguages",
                columns: new[] { "GuideId", "LanguageId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuideSpecialties_GuideId_SpecialtyId",
                table: "GuideSpecialties",
                columns: new[] { "GuideId", "SpecialtyId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GuideSpecialties_SpecialtyId",
                table: "GuideSpecialties",
                column: "SpecialtyId");
